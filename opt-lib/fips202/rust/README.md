...
# Sha3-256
$ cargo run --release --example ckb_opt_fips202_sha3_256 # All cycles: 151031529(144.0M)
$ cargo run --release --example sha3_256                 # All cycles: 255403524(243.6M)

# Sha3-512
$ cargo run --release --example ckb_opt_fips202_sha3_512 # All cycles: 190982005(182.1M)
$ cargo run --release --example sha3_512                 # All cycles: 244129047(232.8M)
```
